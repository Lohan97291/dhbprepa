    ...
    return _buildRenfo(weekIdx, 'S3 — Force + Fractionné', '45-50 min', [
      echauff5min(),
      {
        ...
        sousBlocs:[
          ...
          exo('Pompes déclinées','💪',
            `<strong>${effortSec}s :</strong><br>① Pieds sur chaise, mains au sol, corps aligné<br>② Descente <strong>3s</strong>, remontée explosive${mat==='salle' ? '<br>🏋️ <em>En salle : développé incliné ou développé couché — 3s descente, remontée explosive</em>' : ''}`,
      ...
      echauff5min(),
      {
        ...
        sousBlocs:[
          ...
          exo('Hip Thrust unilatéral','🍑',
            `<strong>${effortSec}s par jambe :</strong><br>① Épaules sur canapé, UN pied au sol, l'autre jambe levée<br>② Monte les hanches sur une seule jambe, serre le fessier<br>③ Tiens <strong>2s</strong> en haut, descends <strong>3s</strong>${mat==='salle' ? '<br>🏋️ <em>En salle : Hip Thrust à la machine ou barre sur les hanches — charge maximale de la semaine</em>' : mat==='elast' ? '<br>🟡 <em>Élastique : passe-le sur la hanche, coince sous le pied d\'appui pour plus de résistance</em>' : ''}`,
