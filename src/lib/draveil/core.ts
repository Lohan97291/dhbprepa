...
export function genSeanceRenfo(weekIdx, joueur, effortSec=35, recupSec=25){
      ...
      echauff5min(),
      {
        ...
        sousBlocs:[
          exo('Squat poids du corps','🦵',
            `<strong>${effortSec}s — descends et remonte, le plus de fois possible</strong><br>Pieds écartés largeur des épaules, orteils légèrement ouverts. Descends lentement comme si tu t'asseyais sur une chaise — 3 secondes pour descendre, cuisses parallèles au sol. Remonte en poussant dans tes talons. Dos droit, regarde devant toi.<br><br>😮‍💨 <em>Pendant la récup :</em> Marche sur place, secoue les jambes, respire.`,
            '⚠️ Genoux dans l\'axe des orteils — s\'ils rentrent vers l\'intérieur, remonte un peu plus haut'),
          exo('Pompes','💪',
            `<strong>${effortSec}s — descends la poitrine vers le sol et remonte</strong><br>Mains un peu plus larges que les épaules, corps aligné de la tête aux talons. Descends lentement en 2 secondes, poitrine proche du sol. Remonte en poussant fort.${mat==='salle' ? '<br>🏋️ <em>En salle : développé couché à la barre ou aux haltères</em>' : ''}<br><br>😮‍💨 <em>Pendant la récup :</em> Reste debout, agite les bras, respire.`,
            '💡 Trop dur ? Pose les genoux au sol — mieux vaut finir sur les genoux que de s\'arrêter'),
          exo('Fentes alternées','🦵',
            `<strong>${effortSec}s — alterne jambe gauche et jambe droite</strong><br>Fais un grand pas en avant. Le genou avant forme un angle droit, le genou arrière frôle le sol sans le toucher. Remonte en poussant sur ton talon avant, puis change de jambe.<br><br>😮‍💨 <em>Pendant la récup :</em> Marche lentement, relâche les cuisses.`,
            '⚠️ Le genou avant ne dépasse pas la pointe de ton pied'),
          exo('Gainage ventral','🔷',
            `<strong>${effortSec}s — tiens la position sans bouger</strong><br>Appui sur les avant-bras et les orteils. Corps aligné comme une planche — ni les fesses en l'air, ni le dos qui creuse. Serre le ventre et les fesses, et respire normalement.<br><br>😮‍💨 <em>Pendant la récup :</em> Allonge-toi sur le dos 10 secondes, respire profondément.`,
            '💡 Si tu trembles beaucoup : pose un genou — tenir 30s bien vaut mieux que trembler 5s'),
          exo('Pont fessier','🍑',
            `<strong>${effortSec}s — monte et descends les hanches</strong><br>Allongé sur le dos, pieds à plat au sol, genoux pliés. Monte les hanches en serrant très fort les fesses. Tiens 2 secondes en haut. Redescends lentement. Pieds bien à plat — pas sur les orteils.<br><br>😮‍💨 <em>Pendant la récup :</em> Reste allongé, jambes étendues, respire.`,
            '💡 Pour bien sentir : pousse dans tes talons, serre les fesses fort en haut'),
        ],
      },
      {
      ...
      echauff5min(),
      {
        ...
        sousBlocs:[
          exo('Squat lent explosif','🦵',
            `<strong>${effortSec}s — descends très lentement, remonte vite</strong><br>Pieds écartés largeur des épaules. Descends en comptant 4 secondes — c'est volontairement lent, c'est ce qui muscle vraiment. Tiens 1 seconde en bas. Remonte rapidement en poussant dans tes talons.<br><br>😮‍💨 <em>Pendant la récup :</em> Marche sur place, secoue les jambes, respire.`,
            '💡 La descente lente, c\'est ce qui construit la force — pas la rapidité'),
          exo('Fente arrière lente','🦵',
            `<strong>${effortSec}s — alterne jambe gauche et jambe droite</strong><br>Debout, recule un pied et pose le genou arrière près du sol. Prends 3 secondes pour descendre. Le genou avant reste au-dessus du pied, dans l'axe. Remonte en poussant sur ton talon avant. Change de jambe.<br><br>😮‍💨 <em>Pendant la récup :</em> Marche lentement, relâche les cuisses et les fessiers.`,
            '⚠️ Le genou avant ne dépasse pas la pointe de ton pied — si tu as mal au genou, remonte un peu plus haut'),
          exo('Pompes déclinées','💪',
            `<strong>${effortSec}s — pieds sur une chaise, mains au sol</strong><br>Pose les pieds sur une chaise ou contre un mur, mains au sol un peu plus larges que les épaules. Descends lentement en 3 secondes, poitrine vers le sol. Remonte en poussant fort. Corps droit comme une planche.<br>💡 <em>Pas de chaise ? Fais des pompes normales.</em><br><br>😮‍💨 <em>Pendant la récup :</em> Reste debout, agite les bras, respire.`,
            '⚠️ Les hanches ne doivent pas s\'affaisser vers le bas'),
          exo('Hip Thrust','🍑',
            `<strong>${effortSec}s — épaules sur le canapé, pousse les hanches vers le haut</strong><br>Assis par terre, appuie tes épaules sur un canapé ou une chaise. Pieds à plat au sol, genoux pliés. Monte les hanches en serrant fort les fesses. Tiens 2 secondes en haut. Redescends lentement en 3 secondes.${mat==='salle' ? '<br>🏋️ <em>En salle : barre sur les hanches, haltères, ou machine hip thrust</em>' : mat==='elast' ? '<br>🟡 <em>Élastique : passe-le sur tes hanches, coince-le sous tes pieds</em>' : '<br>💡 <em>Trop facile ? Leste avec un sac à dos posé sur les hanches</em>'}<br><br>😮‍💨 <em>Pendant la récup :</em> Reste assis par terre, jambes étendues, respire.`,
            '💡 Même exercice que le pont fessier mais avec plus d\'amplitude — bien plus efficace'),
          exo('Gainage latéral','🔷',
            `<strong>${effortSec}s par côté — tiens sur l'avant-bras</strong><br>Allongé sur le côté, appui sur l'avant-bras, coude juste sous l'épaule. Décolle le bassin pour aligner la tête, les hanches et les pieds. Hanche haute, ne la laisse pas descendre. Respire normalement.<br><br>😮‍💨 <em>Pendant la récup :</em> Allonge-toi sur le dos, respire profondément.`,
            '💡 Vaut mieux tenir 15s bien que 30s avec la hanche qui s\'affaisse'),
        ],
      },
      {
      ...
      echauff5min(),
      {
        ...
        sousBlocs:[
          exo('Squat lent (4s descente)','🦵',
            `<strong>${effortSec}s — descends très lentement, remonte vite</strong><br>Pieds écartés largeur des épaules. Compte 4 secondes pour descendre — c'est volontairement lent. Tiens 1 seconde en bas, cuisses parallèles au sol. Puis remonte vite en poussant dans tes talons. Genoux dans l'axe, dos droit.<br><br>😮‍💨 <em>Pendant la récup :</em> Marche sur place, secoue les jambes.`,
            '💡 4 secondes pour descendre = deux fois plus efficace qu\'un squat normal'),
          exo('Hip Thrust','🍑',
            `<strong>${effortSec}s — épaules sur le canapé, pousse les hanches vers le haut</strong><br>Assis par terre, épaules appuyées sur le canapé ou une chaise. Pieds à plat au sol. Monte les hanches en serrant fort les fesses. Tiens 2 secondes en haut. Redescends lentement en 3 secondes.${mat==='elast' ? '<br>🟡 <em>Élastique : passe-le sur tes hanches, coince-le sous tes pieds</em>' : mat==='salle' ? '<br>🏋️ <em>En salle : barre, haltères ou machine</em>' : '<br>💡 <em>Trop facile ? Pose un sac à dos lesté sur les hanches</em>'}<br><br>😮‍💨 <em>Pendant la récup :</em> Reste assis, jambes étendues, respire.`,
            '💡 Serre les fesses fort en haut — si tu ne les sens pas, c\'est que ça ne travaille pas assez'),
          exo('Pompes déclinées','💪',
            `<strong>${effortSec}s — pieds en hauteur, mains au sol</strong><br>Pose tes pieds sur une chaise ou contre un mur. Mains au sol, corps aligné. Descends lentement en 3 secondes, poitrine vers le sol. Remonte en poussant fort.${mat==='salle' ? '<br>🏋️ <em>En salle : développé incliné ou couché — même tempo 3s descente</em>' : ''}<br>💡 <em>Pas de chaise ? Fais des pompes normales.</em><br><br>😮‍💨 <em>Pendant la récup :</em> Debout, agite les bras, respire.`,
            '⚠️ Les hanches ne doivent pas s\'affaisser'),
          exo('Superman','🔷',
            `<strong>12 répétitions — décolle bras et jambes en même temps</strong><br>Allongé face au sol, bras tendus devant toi. En même temps : décolle les bras et les jambes du sol. Tiens 2 secondes en haut — tu dois sentir ton dos travailler. Redescends lentement en 3 secondes.<br><br>😮‍💨 <em>Pendant la récup :</em> Reste allongé sur le ventre, respire, relâche.`,
            '💡 Ça travaille le bas du dos, les fessiers et les ischios en même temps — exercice précieux'),
          exo('Nordic Curl','🦵',
            `<strong>4 à 6 répétitions — l'exercice le plus difficile, et le plus important</strong><br>Coince tes pieds sous un meuble lourd ou fais-toi tenir les chevilles. Corps bien droit. Laisse-toi tomber vers l'avant le plus lentement possible — compte 4 à 5 secondes pour descendre. Ce sont les ischios qui freinent la chute. Pose les mains pour te rattraper et remonte avec les bras.${mat==='elast' ? '<br>🟡 <em>Élastique aux chevilles fixé à un meuble derrière toi : ça aide à remonter</em>' : mat==='salle' ? '<br>🏋️ <em>En salle : machine à ischio ou GHD</em>' : ''}<br><br>😮‍💨 <em>Pendant la récup :</em> Reste assis, étire doucement les ischios — jambe tendue, penche le buste légèrement en avant.`,
            '💡 Même 3 répétitions bien faites c\'est excellent — c\'est l\'exercice n°1 pour éviter les blessures aux ischios'),
        ],
      },
      {
      ...
      echauff5min(),
      {
        ...
        sousBlocs:[
          exo('Squat rapide enchaîné','⚡',
            `<strong>${effortSec}s — le plus de squats possible, sans t'arrêter</strong><br>Pieds écartés, descends en 2 secondes — cuisses parallèles au sol. Remonte le plus vite possible. Enchaîne directement sans pause entre chaque rep. Si les genoux vont bien : ajoute un saut à la remontée.<br><br>😮‍💨 <em>Pendant la récup :</em> Marche sur place, secoue les jambes, respire profondément.`,
            '⚠️ Genoux en priorité — si tu as mal, enlève le saut et reste sur le squat rapide'),
          exo('Fente arrière rapide','⚡',
            `<strong>${effortSec}s — alterne les jambes le plus vite possible</strong><br>Recule un pied en fente basse, genou arrière près du sol. Remonte vite en poussant sur le talon avant, change de jambe. Rythme plus rapide qu'en S2 mais pas de saut — amplitude complète à chaque répétition.<br><br>😮‍💨 <em>Pendant la récup :</em> Marche lentement, relâche les cuisses.`,
            '💡 Plus vite = plus intense, mais le genou avant reste toujours dans l\'axe du pied'),
          exo('Pompes explosives','💪',
            `<strong>${effortSec}s — remontée la plus explosive possible</strong><br>Position de pompe classique, corps aligné. Descends lentement. Remonte en poussant fort et vite — essaie de décoller les mains du sol. Si tu y arrives, claque les mains en l'air.<br><br>😮‍💨 <em>Pendant la récup :</em> Debout, agite les bras, respire.`,
            '💡 L\'objectif c\'est la puissance de la remontée — même sans décoller, pousse aussi fort que possible'),
          exo('Hip Thrust unilatéral','🍑',
            `<strong>${effortSec}s par jambe — une jambe à la fois</strong><br>Épaules sur le canapé, UN seul pied au sol, l'autre jambe levée. Monte les hanches sur une seule jambe en serrant fort le fessier. Tiens 2 secondes en haut. Redescends lentement en 3 secondes. Fais le temps complet d'un côté, puis l'autre.${mat==='salle' ? '<br>🏋️ <em>En salle : machine hip thrust ou barre — charge maximale de la semaine</em>' : mat==='elast' ? '<br>🟡 <em>Élastique sur la hanche, coincé sous le pied d\'appui</em>' : ''}<br><br>😮‍💨 <em>Pendant la récup :</em> Reste assis, jambes étendues, respire.`,
            '💡 Bien plus dur que les deux jambes ensemble — si tu tiens, c\'est que ça travaille vraiment'),
          exo('Nordic Curl — série complète','🦵',
            `<strong>5 à 8 répétitions — tombe le plus lentement possible</strong><br>Coince tes pieds sous un meuble lourd ou fais-toi tenir. Corps bien droit. Laisse-toi tomber vers l'avant en comptant 5 secondes — les ischios freinent. Pose les mains pour te rattraper. Remonte avec les bras.${mat==='salle' ? '<br>🏋️ <em>En salle : machine à ischio ou GHD — même principe</em>' : mat==='elast' ? '<br>🟡 <em>Élastique fixé derrière toi aux chevilles — aide à remonter</em>' : ''}<br><br>😮‍💨 <em>Pendant la récup :</em> Assis, étire doucement les ischios — jambe tendue, penche légèrement le buste.`,
            '💡 Volume maximum du cycle — la séance la plus importante pour protéger tes ischios'),
          exo('Mountain climbers','🔥',
            `<strong>${effortSec}s — ramène les genoux vers la poitrine en courant</strong><br>Mets-toi en position de pompe, bras tendus. Ramène alternativement chaque genou vers la poitrine le plus vite possible — comme si tu courais sur place en appui sur les mains. Hanches basses, ventre serré.<br><br>😮‍💨 <em>Pendant la récup :</em> Debout, marche, respire — tu l'as mérité.`,
            '💡 Cardio intense sans aucun impact sur les genoux — le meilleur finisseur'),
        ],
      },
      {
  ...
  return _buildRenfo(weekIdx, 'S5 — Affûtage ⚡ + Cardio léger', '40-45 min', [
    echauff5min(),
    {
      ...
      sousBlocs:[
        exo('Squat explosif','⚡',
          `<strong>${effortSec}s — descends vite, remonte encore plus vite</strong><br>Pieds écartés, descends en 2 secondes. Remonte de façon explosive — pousse dans les talons avec toute ta force. Si les genoux vont bien, ajoute un saut. Sinon, remontée rapide sans saut — l'effet est presque le même.<br><br>😮‍💨 <em>Pendant la récup :</em> Marche sur place, secoue les jambes.`,
          '💡 C\'est la semaine d\'affûtage — qualité et fraîcheur en priorité sur le volume'),
        exo('Pompes explosives','💪',
          `<strong>${effortSec}s — pousse aussi fort que possible</strong><br>Position de pompe classique, corps aligné. Descends normalement. Remonte en poussant de toutes tes forces — essaie de décoller les mains. Claque-les si tu peux. Enchaîne immédiatement.<br><br>😮‍💨 <em>Pendant la récup :</em> Debout, agite les bras, respire.`,
          '💡 Cette semaine on cherche l\'activation — pas l\'épuisement'),
        exo('Fente arrière explosive','🦵',
          `<strong>${effortSec}s — alterne les jambes avec de la puissance</strong><br>Recule un pied en fente basse, genou arrière proche du sol. Remonte fort en poussant sur le talon avant. Change de jambe rapidement. Pas de saut — mais remontée puissante à chaque fois.<br><br>😮‍💨 <em>Pendant la récup :</em> Marche lentement, relâche les cuisses.`,
          '💡 Même efficacité que la fente sautée pour activer les jambes — sans l\'impact'),
        exo('Gainage ventral','🔷',
          `<strong>${effortSec}s — tiens bien la position jusqu'au bout</strong><br>Appui sur les avant-bras et les orteils. Corps aligné comme une planche. Serre le ventre et les fesses, respire normalement. Cette semaine c'est le seul exercice de gainage — fais-le bien.<br><br>😮‍💨 <em>Pendant la récup :</em> Allonge-toi sur le dos, respire.`,
          '💡 Qualité obligatoire — c\'est la dernière semaine, finis proprement'),
        exo('Pont fessier','🍑',
          `<strong>${effortSec}s — monte et descends les hanches</strong><br>Allongé sur le dos, pieds à plat au sol, genoux pliés. Monte les hanches en serrant fort les fesses. Tiens 2 secondes en haut. Redescends lentement. C'est le dernier exercice de la semaine — finis bien.<br><br>😮‍💨 <em>Pendant la récup :</em> Reste allongé, respire — tu as fini le circuit.`,
          '💡 Dernier exercice du cycle — garde un peu de jus pour le retour collectif'),
      ],
    },
    {
...
export function genSeanceCardio(weekIdx, joueur, effortSec=35, recupSec=25){
  ...
  const renfoLeger = {
    ...
    effortSec, recupSec, recupPassageSec:60, passages:2,
    sousBlocs:[
      exo('Gainage ventral','🔷',
        `<strong>${effortSec}s — tiens la position sans bouger</strong><br>Appui sur les avant-bras et les orteils. Corps aligné de la tête aux talons, comme une planche. Serre le ventre et les fesses, respire normalement.<br><br>😮‍💨 <em>Pendant la récup :</em> Allonge-toi sur le dos, respire.`,
        '💡 Ni les fesses en l\'air, ni le dos qui creuse — une ligne droite'),
      exo('Pompes','💪',
        `<strong>${effortSec}s — descends vers le sol et remonte</strong><br>Mains un peu plus larges que les épaules. Descends lentement en 2 secondes, poitrine proche du sol. Remonte en poussant fort. Sur les genoux si besoin.<br><br>😮‍💨 <em>Pendant la récup :</em> Debout, agite les bras, respire.`,
        '💡 Qualité avant quantité'),
      exo('Pont fessier','🍑',
        `<strong>${effortSec}s — monte et descends les hanches</strong><br>Allongé sur le dos, pieds à plat au sol, genoux pliés. Monte les hanches en serrant fort les fesses. Tiens 2 secondes en haut. Redescends lentement.<br><br>😮‍💨 <em>Pendant la récup :</em> Reste allongé, jambes étendues, respire.`,
        '💡 Pousse dans les talons — si tu les sens travailler, c\'est bon'),
    ],
  };
